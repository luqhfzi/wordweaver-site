      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Ready to take your digital marketing to the next level? We're here to help you 
            develop strategies that drive real results for your business.
          </p>
        </div>
          ...
          <div className="space-y-8">
              ...
              <CardContent className="space-y-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">hello@digitalgrow.com</p>
                  </div>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <h4 className="font-medium mb-2">Do you work with small businesses?</h4>
                  <p className="text-sm text-muted-foreground">
                ...
                <div>
                  <h4 className="font-medium mb-2">What services do you offer?</h4>
                  <p className="text-sm text-muted-foreground">
                    We provide consulting and strategy for SEO, social media, content marketing, 
                    PPC advertising, and comprehensive digital marketing planning.
                  </p>
                </div>
              </CardContent>
            </Card>
